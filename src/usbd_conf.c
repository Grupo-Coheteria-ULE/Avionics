/**
 * @file usbd_conf.c
 * @brief USB Device low-level driver (HAL PCD callbacks + LL functions).
 */
...
static uint32_t usb_mem[(sizeof(USBD_CDC_HandleTypeDef) / 4) + 1];
...
USBD_StatusTypeDef USBD_LL_Init(USBD_HandleTypeDef *pdev)
{
    ...
    HAL_PCD_SetTxFiFo(&hpcd_USB_OTG_FS, 1, 128);
